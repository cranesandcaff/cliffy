import { ICommand, ICommands } from './definitions';
 ...
 */
export function parseCommand(promptResponse: string[], commands: ICommands): (
  { command: ICommand, remainingPieces: string[] } | false
) {
